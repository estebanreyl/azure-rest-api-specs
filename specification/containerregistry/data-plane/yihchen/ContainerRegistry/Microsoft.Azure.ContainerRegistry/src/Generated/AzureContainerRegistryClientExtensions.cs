...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public static partial class AzureContainerRegistryClientExtensions
    {
            ...
            /// <summary>
            /// Put the image manifest file associated with the specified name and
            /// reference. Reference may be a tag or a digest
            /// </summary>
            /// <param name='operations'>
            /// The operations group for this extension method.
            ...
            /// The cancellation token.
            /// </param>
            public static async Task PutManifestAsync(this IAzureContainerRegistryClient operations, string name, string reference, Manifest payload, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.PutManifestWithHttpMessagesAsync(name, reference, payload, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// </param>
            /// <param name='last'>
            /// query parameter for the last item in previous query
            /// </param>
            /// <param name='n'>
